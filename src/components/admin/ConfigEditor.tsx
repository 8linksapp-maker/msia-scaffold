            ...
            <div className="p-8 bg-white border border-slate-200 rounded-2xl shadow-sm">
                ...
                <div className="flex gap-2">
                    {[
                        ...
                        return (
                            <label key={opt.value} className={`relative flex-1 p-4 border-2 rounded-xl cursor-pointer transition-all text-center ${active ? 'border-violet-500 bg-violet-50 shadow-sm' : 'border-slate-200 hover:border-slate-300'}`}>
                                ...
                                {opt.recommended && (
                                    <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-violet-600 text-white">recomendado</span>
                                )}
